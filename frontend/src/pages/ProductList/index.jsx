...
const ProductListPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins p-4 items-center justify-start mx-auto w-full">
        <Header className="flex items-center justify-center md:px-5 w-full " />
        <div className="flex flex-col items-start justify-start w-full ">
          <div className="flex items-center justify-start ml-18 mt-5 md:ml-[0] md:px-5 w-[31%] md:w-full">
            <Text
          ...
          <Text
            className="md:ml-[0] ml-[658px] text-4xl sm:text-[32px] md:text-[34px] text-gray-800"
            size="txtPoppinsBold36"
          >
            Product List
          </Text>
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1632px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col gap-8 items-center justify-start w-[84%] md:w-full">
              ...
              >
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="md:gap-5 gap-8 grid sm:grid-cols-1 md:grid-cols-3 grid-cols-4 justify-center min-h-[auto] w-full">
                    ...
                    <Prodcards name={"Green Warm jacket"} img={'images/img_placeholder_3.png'} price={'Rs 2000'}/>
                    <div className="flex flex-1 flex-col gap-4 items-center justify-start pb-1 w-full">
                      <Img
                        className="h-[245px] md:h-auto object-cover w-[245px]"
...
const Prodcards = (props) => {
  return (
    <div>
         <div className="flex flex-1 flex-col gap-4 items-center justify-start pb-1 w-full hover:shadow-lg ">
                      <Img
                        className="h-[245px] md:h-auto object-cover w-[245px]"
                        src={`${props.img}`}
                        alt="placeholder"
                      ...
                      <div className="flex flex-col gap-2 items-center justify-start w-auto">
                        <Text
                          className="text-2xl w-[70%] md:text-[22px] text-center text-gray-800 sm:text-xl"
                          size="txtPoppinsMedium24"
                        >
                          <>
                            {props.name}
