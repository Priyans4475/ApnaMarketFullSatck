            ...
            <div className="absolute flex inset-[0] justify-center m-auto w-full">
              ...
              <div className="flex md:flex-col flex-row gap-[26px] items-center justify-between ml-[-109px] my-auto w-[84%] z-[1]">
                <List
                  ...
                  orientation="horizontal"
                >
                  <div className="bg-white-A700 flex flex-col gap-4 h-[362px] md:h-auto items-center justify-center sm:ml-[0] p-6 sm:px-5 shadow-bs w-[318px]">
                    <Img
                ...
                <List
                  ...
                  orientation="horizontal"
                >
                  <div className="bg-white-A700 flex flex-col gap-4 h-[361px] md:h-auto items-center justify-center sm:ml-[0] p-6 sm:px-5 shadow-bs w-[318px]">
                    <Img
                      className="h-[200px] md:h-auto object-cover w-[200px]"
          ...
          <div className="flex flex-col items-center justify-start mt-[100px] w-full">
            <div className="h-[362px] md:h-[466px] sm:h-[964px] md:px-5 relative w-full">
              ...
              <List
                ...
                orientation="horizontal"
              >
                <div className="bg-white-A700 flex flex-row gap-8 h-[217px] md:h-auto items-center justify-center sm:ml-[0] sm:px-5 px-8 py-16 shadow-bs1 w-96 sm:w-full">
                  <Img
                    className="h-12 w-12"
